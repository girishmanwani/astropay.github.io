...
- `server.js` — the backend: creates orders, verifies payments, gates the download
- `private-assets/ebook.pdf` — **placeholder file, replace with your real ebook**
- `.env` — pre-filled with the **test** Razorpay keys you shared, so you can try
  the whole flow immediately without spending real money
